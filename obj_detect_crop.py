...
while (i<=1):   ## range of the toltal files/images in the directory
    ...
    detections = detector.detectObjectsFromImage(input_image=os.path.join(execution_path , "original.jpg"), output_image_path=os.path.join(execution_path , "cnew0.png"), display_object_name = False, display_percentage_probability = False, minimum_percentage_probability=90)
