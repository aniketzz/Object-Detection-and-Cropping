...
from detect.Detection.keras_retinanet.models.resnet import resnet50_retinanet
from detect.Detection.keras_retinanet.utils.image import read_image_bgr, read_image_array, read_image_stream, \
    preprocess_image, resize_image
from detect.Detection.keras_retinanet.utils.visualization import draw_box, draw_caption
from detect.Detection.keras_retinanet.utils.colors import label_color
...
from detect.Detection.YOLOv3.models import yolo_main, tiny_yolo_main
from detect.Detection.YOLOv3.utils import letterbox_image, yolo_eval
...
class ObjectDetection:
    """
                    This is the object detection class for images in the detect library. It provides support for RetinaNet
    ...
    def __init__(self):
        ...
        ##self.numbers_to_names = {0: 'person', 1: 'bicycle'}
...
class VideoObjectDetection:
    """
                    This is the object detection class for videos and camera live stream inputs in the detect library. It provides support for RetinaNet,
                     YOLOv3 and TinyYOLOv3 object detection networks. After instantiating this class, you can set it's properties and
                     make object detections using it's pre-defined functions.
